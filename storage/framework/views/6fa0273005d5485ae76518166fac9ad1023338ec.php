...
<?php $__env->startSection('content'); ?>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title"><?php echo e(trans('panel.webinar_comments_list')); ?></h2>
        </div>
                                ...
                                <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class=" text-left align-middle" width="35%">
                                            <a href="<?php echo e($comment->webinar->getUrl()); ?>" target="_blank" class="text-dark-blue font-weight-500"><?php echo e($comment->webinar->title); ?></a>
                                        </td>
                                        ...
                                        <td class="align-middle text-right">
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <button type="button" data-item-id="<?php echo e($comment->webinar_id); ?>" data-comment-id="<?php echo e($comment->id); ?>" class="btn-transparent webinar-actions d-block mt-10 text-hover-primary report-comment"><?php echo e(trans('panel.report')); ?></button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vertexpr/public_html/portal/resources/views/web/default/panel/webinar/comments.blade.php ENDPATH**/ ?>