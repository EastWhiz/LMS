                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td width="25%"><?php echo nl2br($report->message); ?></td>
                                            <td><?php echo e(dateTimeFormat($report->created_at, 'Y M j | H:i')); ?></td>

                                            <td width="150px">


                                                <a href="/admin/comments/<?php echo e($page); ?>/<?php echo e($report->comment_id); ?>/edit" class="btn-transparent  text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.show')); ?>">
                                                    <i class="fa fa-eye"></i>
                                                </a>

                                                <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/comments/'. $page .'/reports/'.$report->id.'/delete','btnClass' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homenew/vertexpr/public_html/portal/resources/views/admin/comments/reports.blade.php ENDPATH**/ ?>