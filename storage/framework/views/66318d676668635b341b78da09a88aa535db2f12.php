                            ...
                            <tr>
                                ...
                                <td class="" width="50">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products_reviews_status_toggle')): ?>
                                        <a href="/admin/store/reviews/<?php echo e($review->id); ?>/toggleStatus" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(($review->status == 'active') ? 'Hidden' : 'Publish'); ?>">
                                            <?php if($review->status == 'active'): ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products_reviews_delete')): ?>
                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/store/reviews/'. $review->id.'/delete','btnClass' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homenew/vertexpr/public_html/portal/resources/views/admin/store/reviews/lists.blade.php ENDPATH**/ ?>