            ...
            <div class="row align-items-center mt-20">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="amount" value="<?php echo e(!empty($meeting) ? $meeting->amount : old('amount')); ?>" class="form-control" placeholder="<?php echo e(trans('panel.number_only')); ?>"/>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 <?php echo e(((!empty($meeting) and $meeting->in_person) or old('in_person') == 'on') ? '' :  'd-none'); ?>" id="inPersonMeetingAmount">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="in_person_amount" value="<?php echo e(!empty($meeting) ? $meeting->in_person_amount : old('in_person_amount')); ?>" class="form-control" placeholder="<?php echo e(trans('panel.number_only')); ?>"/>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mt-15">
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="online_group_amount" value="<?php echo e(!empty($meeting) ? $meeting->online_group_amount : old('online_group_amount')); ?>" class="form-control" placeholder="<?php echo e(trans('panel.number_only')); ?>"/>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-15">
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="in_person_group_amount" value="<?php echo e(!empty($meeting) ? $meeting->in_person_group_amount : old('in_person_group_amount')); ?>" class="form-control" placeholder="<?php echo e(trans('panel.number_only')); ?>"/>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homenew/vertexpr/public_html/portal/resources/views/web/default/panel/meeting/settings.blade.php ENDPATH**/ ?>