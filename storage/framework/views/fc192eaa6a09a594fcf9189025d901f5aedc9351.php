            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e(addCurrencyToPrice($bundleSalesAmount)); ?></strong>
                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        ...
                                        <span class="stat-value"><?php echo e(count($bundle->sales)); ?> (<?php echo e((!empty($bundle->sales) and count($bundle->sales)) ? addCurrencyToPrice($bundle->sales->sum('amount')) : 0); ?>)</span>
                                    </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homenew/vertexpr/public_html/portal/resources/views/web/default/panel/bundle/index.blade.php ENDPATH**/ ?>