                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <span class="d-block font-12"><?php echo e(!empty($user->physical_products_sales) ? addCurrencyToPrice($user->physical_products_sales) : 0); ?></span>
                                            </td>

                                            <td class="text-center">
                                                <span class="d-block font-14"><?php echo e($user->virtual_products_count); ?></span>
                                                <span class="d-block font-12"><?php echo e(!empty($user->virtual_products_sales) ? addCurrencyToPrice($user->virtual_products_sales) : 0); ?></span>
                                            </td>

                                            <td class="text-center">
                                                <span class="d-block font-12"><?php echo e(!empty($user->total_sales) ? addCurrencyToPrice($user->total_sales) : 0); ?></span>
                                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homenew/vertexpr/public_html/portal/resources/views/admin/store/sellers/index.blade.php ENDPATH**/ ?>