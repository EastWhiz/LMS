                    ...
                    <div class="card">
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_filters_create')): ?>
                                <a href="/admin/store/filters/create" class="btn btn-primary"><?php echo e(trans('admin/main.add_new')); ?></a>
                            <?php endif; ?>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_filters_edit')): ?>
                                                    <a href="/admin/store/filters/<?php echo e($filter->id); ?>/edit"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_filters_delete')): ?>
                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/store/filters/'.$filter->id.'/delete'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /homenew/vertexpr/public_html/portal/resources/views/admin/store/filters/lists.blade.php ENDPATH**/ ?>