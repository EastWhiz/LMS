...
//Comments
    ...
    'classes_comments' => 'Video Comments',
    ...
    'reports' => 'Reports',
    'classes_comments_reports' => 'Video Comments',
    'classes_reports' => 'Video Reports',
...
//Dashboard
    ...
    'daily_sales_type_statistics' => 'Video Type Daily Sales',
    ...
    'pending_review' => 'Pending Review',
  	'pending_review_classes' => 'Pending Review Videos',
...
//Filters Types
    ...
    'students_ascending' => 'Employees - Ascending',
    'students_descending' => 'Employees - Descending',
    'passed_students_ascending' => 'Passed Employees - Ascending',
    'passes_students_descending' => 'Passed Employees - Descending',
    'grades_average_ascending' => 'Average Grade - Ascending',
    'grades_average_descending' => 'Average Grade - Descending',
    'classes_sales_ascending' => 'Video Sales - Ascending',
    'classes_sales_descending' => 'Video Sales - Descending',
    'purchased_classes_ascending' => 'Purchased Videos - Ascending',
    'purchased_classes_descending' => 'Purchased Videos - Descending',
    ...
    'discounted_classes' => 'Discounted Videos',
...
//Financial
    ...
    'special_offers' => 'Video Discounts',
    'special_offers_list_page_title' => 'Video Discounts',
    'from_date' => 'From Date',
    'to_date' => 'To Date',
...
// Pages Title
    ...
    'webinar_new_page_title' => 'New Video',
...
// Settings-main
    ...
    'notification_course_created' => 'Video Submission',
    'notification_course_approve' => 'Video Approval',
    'notification_course_reject' => 'Video Rejection',
    ...
    'latest_classes' => 'Latest Videos',
    'best_sellers' => 'Best Sellers',
    'free_classes' => 'Free Videos',
    'discount_classes' => 'Discounted Videos',
    'best_rates' => 'Best Rated Videos',
	...
	'select_a_partner_hint' => 'Partner instrcutor will have access to the video content and their profile will be displayed on the video page.',
...
//Tags
    ...
    'admin_tags_delete' => 'Tags Delete',
  	'create_field_title_placeholder' => 'Tags will be displayed on the video page.',
...
//Users
    ...
    'classes' => 'Videos',
    'class' => 'Video',
    'classes_sales' => 'Video Sales',
    'purchased_classes' => 'Purchased Videos',
    ...
    'select_a_instructor' => 'Select an Instructor',
  	...
  	'search_student' => 'Search for Employee',
...
///User Badges
    ...
    'course_count' => 'Videos Count',
    'course_rate' => 'Videos Rating',
    'sale_count' => 'Video Sales Count',
    'support_rate' => 'Support Rating',
    'condition' => 'Condition',
    'condition_register_date' => 'Day',
    'condition_course_count' => 'Videos',
    ...
    'classes_conversations' => 'Videos Support',
    'course_conversations' => 'Video Conversations',
...
//Classes
    ...
    'text_courses' => 'Text Videos',
    'webinar_title' => 'Video Title',
    'webinar_status' => 'Video Status',
    ...
    'course_type' => 'Video Type',
    'type_webinar' => 'Video',
    'type_text_lesson' => 'Text Video',
    'type_course' => 'Video',
    'type_webinars' => 'Live Class',
    'type_text_lessons' => 'Text Video',
    'type_courses' => 'Videos',
    'teacher_name' => 'Instructor',
    'category_name' => 'Category',
    'select_category' => 'Select a Category',
    'select_teacher' => 'Select an Instructor',
    'webinars_count' => 'VIdeos',
    ...
    'search_webinar' => 'Search for a Video',
    'admin_webinars' => 'Webinars',
    'admin_webinars_list' => 'Videos List',
    'admin_webinars_create' => 'New Video',
    'admin_webinars_edit' => 'Video Edit',
    'admin_webinars_delete' => 'Video Delete',
    'feature_webinars' => 'Featured Videos',
    'feature_webinar_create' => 'New Featured Video',
    'page' => 'Page',
    ...
    'webinars_reports' => 'Video Reports',
...
//Statistic
    ...
    'organizations_students' => 'Organization Employees',
    'inprogress_live_classes' => 'Inprogress Live Classes',
    'total_durations' => 'Total Duration',
    'inactive_students' => 'Inactive Employees',
    'ban_students' => 'Banned Employees',
    'users_without_purchases' => 'Users Without Purchase',
    'teachers_without_class' => 'Instructors Without a Video',
    'featured_classes' => 'Featured Videos',
...
//Hints & Placeholders
    ...
    'consultants_hint_description_2' => 'Meetings that reserved by a employee but not conducted yet. Pending might be in progress or not started.',
    ...
    'organizations_hint_description_3' => 'Each organization can include related instructors and employees. Organizations can create public or private classes.',
    'students_hint_title_1' => 'New Employee',
    'students_hint_title_2' => 'Pending/Active',
    'students_hint_title_3' => 'Inactive/Ban',
    'students_hint_description_1' => 'You can add a new employee from "Users/New" or fill the registration form in the platform frontend.',
    ...
    'price_plan_modal_capacity_hint' => 'Fill it if you want to limit number of sold tickets. Example: Only 5 employees will get 50% discount. ',
    ...
    'subscribes_list_hint_description_1' => 'Subscription packages will be displayed on the homepage and user panel and users will be able to purchase them and subscribe to Videos that the subscription option is on for them. When the subscription plan date expired, the user wont have access to the content.',
    'subscribes_list_hint_description_2' => 'Subscribe times: Number of videos that the user could subscribe. Days: Subscription plan duration. Popular badge: A badge will be displayed on the package card.',
    'discount_code_hint' => 'Users will use this code to get discount (E.g. Merry_christmas)',
    'new_featured_hint_title_1' => 'Featured Videos Functionality',
    'new_featured_hint_title_2' => 'Featured Videos Positions',
    'new_featured_hint_description_1' => 'Featured videos will be displayed different from normal videos to get more views and traffic. All of the featured videos include a "Featured" badge.',
    'new_featured_hint_description_2' => 'They could be displayed at the top of the home page (Featured videos slider) or top of the category page.',
    ...
    'promotions_list_hint_description_1' => 'Instructors will be able to purchase promotion plans for their videos to increase their view by displaying videos in the best viewing positions.',
    'promotions_list_hint_description_2' => 'Instructors can purchase promotion plans from their panel. The instructor should specify the video during the plan purchase process.',
    'promotions_list_hint_description_3' => 'When a user purchased a plan, the admin can add the selected video to best viewing positions using "Featured video" or "Advertising Banners" features.',
    ...
    'no_index' => 'No Index',
  	...
  	'payouts_title' => 'Payouts ',
   	...
   	'new_product_discount_title' => 'New Video Discount',
   	'edit_product_discount_title' => 'Edit Video Discount',
...
//21 Aug Update
    'invited_instructor_hint' => 'The invited instructor will have access to the video content. Their profile will be shown on the video page.',
  	'affiliate' => 'Affiliate',
  	'referral' => 'Referral',
    ...
    'class_url' => 'Video URL',
    'class_url_hint' => 'The video url must be unique, use it without spaces. It will be generated by default; you can use default.',
    ...
    'seo_metas_reward_courses' => 'Reward Videos',
    ...
    'notification_new_question_in_forum' => 'New Question in Video Forum',
    'notification_new_answer_in_forum' => 'New Answer in Video Forum',
    ...
    'notification_instructor_send_message' => 'New Message from Instructor (for employee)',
    'notification_instructor_set_grade' => 'Assignment Grade (for employee)',
    ...
    'notification_meeting_reserve_reminder' => 'Meeting Reminder (For employee)',
    ...
    'post_in_topic' => 'Forum Posts',
  	'notification_course_students' => 'Video Employee',
    'product_title' => 'Product Title',
    'assignment_grade' => 'Assignment Grade',
    'topic_title' => 'Topic Title',
    
    'private_hint_title_1' => 'Functionality',
    'private_hint_description_1' => 'This feature allows you to enable video access for specific users. It means users in this list won\'t be able to access the video page content and make purchases.',
...
By enabling this feature, newly registered users will require approval using this list.',
    'private_hint_title_3' => 'How to disable access for an approved employee?',
    ...
    'delete_account_description_2' => 'By approving delete account requests all of the user\'s data like videos, settings, etc will be removed. User financial statistics will remain.',
    ...
    'add_a_course_to_the_student' => 'Add a video to the user',
