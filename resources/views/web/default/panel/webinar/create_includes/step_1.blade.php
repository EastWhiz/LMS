...
<div class="row">
    <div class="col-12 col-md-4 mt-15">
        ...
        <div class="form-group mt-15 ">
            ...
            <select name="type" class="custom-select @error('type')  is-invalid @enderror" style="display: none">
                <option value="video" selected>Video</option>
                <option value="webinar">{{ trans('webinars.webinar') }}</option>
                {{-- <option value="course" @if(!empty($webinar) and $webinar->type == 'course') selected @endif>{{ trans('webinars.video_course') }}</option> --}}
                <option value="course">{{ trans('webinars.video_course') }}</option>
                <option value="text_lesson">{{ trans('webinars.text_lesson') }}</option>
            </select>
