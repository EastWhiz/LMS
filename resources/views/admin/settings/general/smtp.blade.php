<div class="tab-pane mt-3 fade @if(!empty($smtp)) show active @endif" id="socials" role="tabpanel" aria-labelledby="socials-tab">
    <div class="row">
        <div class="col-12 col-md-8 col-lg-6">
            <form action="/admin/settings/socials/store" method="post">
                ...
                <input type="hidden" name="smtp" value="{{ !empty($socialKey) ? $socialKey : 'newSocial' }}">
